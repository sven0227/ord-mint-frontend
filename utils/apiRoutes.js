export const host = 'http://95.216.224.119'

export const getOrderUrl = `${host}/getorder`
...
export const ORDINAL_TYPE_BRC20_DEPLOY = 1
export const ORDINAL_TYPE_BRC20_MINT = 2
export const ORDINAL_TYPE_BRC20_TRANSFER = 3